...
import { listVmType, getVmType, delVmType, addVmType, updateVmType } from "@/api/mind/vmType"
...
function handleExport() {
  proxy.download('mind/vmType/export', {
    ...queryParams.value
