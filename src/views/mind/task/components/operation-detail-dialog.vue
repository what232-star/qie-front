  ...
  >
    <div class="task-status">
      <img
        ...
        class="icon"
        :src="getImagePath(taskDada.taskStatus, 'icon')"
      />
      <span class="status">
      ...
      <img
        v-if="taskDada.taskStatus"
        class="pic"
        :src="getImagePath(taskDada.taskStatus, 'pic')"
      />
    </div>
...
// 获取图片路径的方法
const getImagePath = (status, type) => {
  return new URL(`../../../../assets/task/${type}_${status}.png`, import.meta.url).href;
};
